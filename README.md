...
<div class="main">
  ...
  <div class="left-panel">
    ...
    <div>
      ...
      <div class="template-selector">
        <button class="template-btn active" onclick="selectTemplate(this,'soap_new')">New Patient SOAP</button>
        <button class="template-btn" onclick="selectTemplate(this,'soap_followup')">Follow Up Note</button>
        <button class="template-btn" onclick="selectTemplate(this,'referral')">Referral Letter</button>
      </div>
    </div>
  ...
  <div class="right-panel">
    ...
    <div class="spine-container" id="spineContainer">
      <div class="spine-region">
        <div class="region-label">Cervical</div>
        <div class="vertebra-row">
          <div class="vertebra cervical" data-seg="C1" onclick="toggleSegment('C1',this)">C1</div>
          <div class="vertebra cervical" data-seg="C2" onclick="toggleSegment('C2',this)">C2</div>
          <div class="vertebra cervical" data-seg="C3" onclick="toggleSegment('C3',this)">C3</div>
          <div class="vertebra cervical" data-seg="C4" onclick="toggleSegment('C4',this)">C4</div>
        </div>
        <div class="vertebra-row">
          <div class="vertebra cervical" data-seg="C5" onclick="toggleSegment('C5',this)">C5</div>
          <div class="vertebra cervical" data-seg="C6" onclick="toggleSegment('C6',this)">C6</div>
          <div class="vertebra cervical" data-seg="C7" onclick="toggleSegment('C7',this)">C7</div>
        </div>
      </div>
      <div class="spine-region">
        <div class="region-label">Thoracic</div>
        <div class="vertebra-row">
          <div class="vertebra thoracic" data-seg="T1" onclick="toggleSegment('T1',this)">T1</div>
          <div class="vertebra thoracic" data-seg="T2" onclick="toggleSegment('T2',this)">T2</div>
          <div class="vertebra thoracic" data-seg="T3" onclick="toggleSegment('T3',this)">T3</div>
          <div class="vertebra thoracic" data-seg="T4" onclick="toggleSegment('T4',this)">T4</div>
        </div>
        <div class="vertebra-row">
          <div class="vertebra thoracic" data-seg="T5" onclick="toggleSegment('T5',this)">T5</div>
          <div class="vertebra thoracic" data-seg="T6" onclick="toggleSegment('T6',this)">T6</div>
          <div class="vertebra thoracic" data-seg="T7" onclick="toggleSegment('T7',this)">T7</div>
          <div class="vertebra thoracic" data-seg="T8" onclick="toggleSegment('T8',this)">T8</div>
        </div>
        <div class="vertebra-row">
          <div class="vertebra thoracic" data-seg="T9" onclick="toggleSegment('T9',this)">T9</div>
          <div class="vertebra thoracic" data-seg="T10" onclick="toggleSegment('T10',this)">T10</div>
          <div class="vertebra thoracic" data-seg="T11" onclick="toggleSegment('T11',this)">T11</div>
          <div class="vertebra thoracic" data-seg="T12" onclick="toggleSegment('T12',this)">T12</div>
        </div>
      </div>
      <div class="spine-region">
        <div class="region-label">Lumbar</div>
        <div class="vertebra-row">
          <div class="vertebra lumbar" data-seg="L1" onclick="toggleSegment('L1',this)">L1</div>
          <div class="vertebra lumbar" data-seg="L2" onclick="toggleSegment('L2',this)">L2</div>
          <div class="vertebra lumbar" data-seg="L3" onclick="toggleSegment('L3',this)">L3</div>
        </div>
        <div class="vertebra-row">
          <div class="vertebra lumbar" data-seg="L4" onclick="toggleSegment('L4',this)">L4</div>
          <div class="vertebra lumbar" data-seg="L5" onclick="toggleSegment('L5',this)">L5</div>
        </div>
      </div>
      <div class="spine-region">
        <div class="region-label">Sacral / Coccyx</div>
        <div class="vertebra-row">
          <div class="vertebra sacral" data-seg="S1" onclick="toggleSegment('S1',this)">S1</div>
          <div class="vertebra sacral" data-seg="Coccyx" onclick="toggleSegment('Coccyx',this)">Coccyx</div>
        </div>
      </div>
    </div>
    <div>
...
let patients = [];
let notes = [];
try { patients = JSON.parse(localStorage.getItem('chironote_patients') || '[]'); } catch(e) {}
try { notes = JSON.parse(localStorage.getItem('chironote_notes') || '[]'); } catch(e) {}
...
function saveNewPatient() {
  ...
  try { localStorage.setItem('chironote_patients', JSON.stringify(patients)); } catch(e) {}
  closeModal();
